...
\begin{itemize}
    ...
    \item Studenten die alleen wensen te werken aan het groepswerk delen dit mee via een email. Deze studenten moeten bulk-upload & zoeken van een product niet te implementeren.
\end{itemize}{}
\section{Opgave}
